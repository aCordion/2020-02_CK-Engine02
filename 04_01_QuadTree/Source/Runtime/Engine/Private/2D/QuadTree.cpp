...
void QuadTree::Split()
{
	...
	//Vector2 center = Bound.Max * 0.5f;
	//Vector2 center = Bound.Max - Bound.Min;
	Vector2 center = Vector2::Zero;

	//if (   (Bound.Max - center).X < 0.0f
	//	&& (Bound.Max - center).Y < 0.0f)
	//{
	//	// 나눌 수 있는지 확실치 않음
	//	return;
	//}
